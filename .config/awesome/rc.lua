...
-- Set wallpaper
awful.spawn.with_shell("feh --bg-fill $HOME/Pictures/wallpapers/wallpaper.jpg")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "l", function () awful.util.spawn("betterlockscreen -l dim") end,
    ...
    awful.key({}, "XF86AudioMicMute", function () awful.util.spawn("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle") end,
